...
function MakeCostBasedDEDModel(TE_limit = nothing)
...
begin
	...
	for i in 1:num_points
		...
		for g in 1:4
			# FIXME: not sure why I can't manage to do this as a single assignment
...
begin
	plot(1:24, eachrow(value.(P_pareto[best,:,:])), 
