...
function MakeCostBasedDEDModel(ramp_scale = 1.0)
	...
	@constraint(model, RUcon[i=1:4, t=2:24], P[i,t] - P[i,t-1] <= RU[i] * ramp_scale)
	@constraint(model, RDcon[i=1:4, t=2:24], P[i,t-1] - P[i,t] <= RD[i] * ramp_scale)
